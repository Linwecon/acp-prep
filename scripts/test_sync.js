...
for (const m of ['init', 'isConfigured', 'openAuth', 'switchAuthPage', 'switchSignInMethod', 'signInGoogle', 'signInWithPassword', 'signUp', 'sendEmailOtp', 'verifyEmailOtp', 'signOut', 'pushProgress', 'pushFav', 'pushExam', 'pushAll', 'pullAndMerge', '_mergeProgress']) {
